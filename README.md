...
Laravel adalah kerangka kerja aplikasi web dengan sintaks yang ekspresif dan elegan. Kami percaya bahwa pengembangan harus menjadi pengalaman yang menyenangkan dan kreatif agar benar-benar memuaskan. Laravel memudahkan proses pengembangan dengan menyederhanakan tugas-tugas umum yang sering digunakan dalam banyak proyek web, seperti:
...
- [ORM basis data](https://laravel.com/docs/el) yang ekspresif dan intuitif
